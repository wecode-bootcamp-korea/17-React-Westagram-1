            ...
            <div className="feeds">
              <article className="article_feeds">
                <header>
                  ...
                  <a className="account_name" href="">jamongs824</a>
                ...
                <div className="feed_detail">
                  ...
                  <section className="like_account">
                    ...
                    <div className="like_account_count">jiyeon0807님 외 1명이 좋아합니다</div>
                  </section>
                  <div className="comment_list"></div>
                  <div className="comment_input">
                    <form action="" className="form">
                      <textarea className="comment_input_box" name="" autocomplete="off" autocorrect="off" placeholder="댓글 달기..."></textarea>
                      <button className="inactive_button login_btn" type="submit" className="inactive_button">게시</button>
                    </form>
                  </div>
                </div>
              </article>
