      ...
      >
        <nav className="nav__bar">
          ...
          <input
            placeholder="검색"
            type="text"
            className="search__bar container"
          />
          <div className="icons">
            <li>
              <img
          ...
          <div className="wrap-main">
            <div className="feeds">
              ...
              <div className="story container">
                ...
                <div className="user-story">
                  <img
                    ...
                    src="https://www.beautycolorcode.com/2352c6.png"
                    alt=""
                  />
              ...
              <article className="feed container">
                <nav className="users">
                  <div className="user">
                    <button className="user-profile-small-btn">
                      <img
                ...
                <div>
                  ...
                  <div className="contents">
                    ...
                    <ul className="commentList">
                      ...
                      {this.state.commentList.map((input, index) => {
            ...
            <div className="main-right" style={{ display: "none" }}>
              ...
              <div className="profile">
                <button className="profile-img-large">
                  <img src={mj} alt="my photo" style={{ width: "56px" }} />
                </button>
                <button className="username-feed user-btn-large">
                  canon_mj
                </button>
